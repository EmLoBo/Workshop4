const apikey = 'b1f5654e-1508-4446-b3a1-39029082c08c';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function apiUpdateOperation(operationId, operationDescription, timeSpent){
    ...
    function renderOperation(operationsList, status, operationId, operationDescription, timeSpent) {
        ...
        if (status == "open") {
            ...
            add15minButton.addEventListener('click',function(){
                ...
                apiUpdateOperation(operationId, operationDescription, timeSpent).then(
                    time.innerText = formatTime(timeSpent + 15)
            ...
            add1hButton.addEventListener('click',function(){
                ...
                apiUpdateOperation(operationId, operationDescription, timeSpent).then(
                    time.innerText = formatTime(timeSpent + 60)
        ...
        const formAddOperations = document.querySelector('form');
        console.log(formAddOperations);
    }
    ...
    const formAdd = document.querySelector('.js-task-adding-form');
